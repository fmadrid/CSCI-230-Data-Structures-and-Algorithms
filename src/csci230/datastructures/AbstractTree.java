 ...
 *
 * The following three methods remain abstract, and must be implemented by a concrete subclass: 
 ...
 * Based off of work in Michael Goodrich's <i>Data Structures and Algorithms (Java)</i>
 */
public abstract class AbstractTree<E> implements Tree<E> {
   ...
   */
  @Override
  public boolean isInternal(Position<E> p) { return children(p).iterator().hasNext(); }
   ...
   */
  @Override
  public boolean isExternal(Position<E> p) { return !children(p).iterator().hasNext(); }
